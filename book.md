# Manipulator Maintenance Manual - HA006B / HA006L
...
Figure 4.2 Inspection part for main bolts [HA006L]# 4.4. Checking wiring in the manipulator
...
Figure 4.3 Cable inspection part [HA006B/HA006L]# 4.5. Checking the timing belt
...
Figure 4.4 Location to check the tension of B axis timing belt# 5. Maintenance
...
# 6.4. Motor and reducer replacement
...
(When overhauling the robot, you can use the leveler to set the zero point precisely. If you need to calibrate the zero point precisely, please consult with Hyundai Robotics.)# 6.4.2. How to Replace Motor (HA006B/HA006L)
...
Figure 6.12 B/R1 axis motor replacement [HA006B/HA006L]# 6.4.3. Replacing Axis-S Reducer [HA006B]
...
# 6.4.4. Replacing Axis-H, V Reducer [HA006B]
...
# 6.4.5. Replacing Axis-S Reducer [HA006L]
...
Figure 6.20 Axis-S Reducer Disassembly Diagram [HA006L]# 6.4.6. Replacing Axis-H, Axis-V Reducer [HA006L]
...
Figure 6.26 Zero point setting method [HA006L] # 6.5.2. Encoder Reset
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-nrix">HA006L</td>
    <td class="tg-nrix">R3156-7512-001</td>
    <td class="tg-nrix">BJ3 wiring ASSY</td>
    <td class="tg-nrix">1ST</td>
